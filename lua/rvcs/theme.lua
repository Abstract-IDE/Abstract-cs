...
M.plugins = {
  ...
  IndentBlanklineContextChar    = { fg = colors.context },
  ...
  TSBoolean             = { fg = colors.cyan6},
  TSCharacter           = { fg = colors.orange2 },
  TSComment             = { fg = colors.green1 },
  TSConditional         = { fg = colors.cyan6},
  TSConstBuiltin        = { fg = colors.cyan6},
  TSConstMacro          = { fg = colors.cyan3 },
  TSConstant            = { fg = colors.yellow3 },
  TSConstructor         = { fg = colors.cyan3 },
  TSEmphasis            = { style = 'italic' },
  TSError               = { fg = colors.red2 },
  TSException           = { fg = colors.purple2 },
  TSField               = { fg = colors.blue2 },
  TSFloat               = { fg = colors.green3 },
  TSFuncBuiltin         = { fg = colors.yellow3 },
  TSFuncMacro           = { fg = colors.yellow3 },
  TSFunction            = { fg = colors.yellow3 },
  TSInclude             = { fg = colors.purple2 },
  TSKeyword             = { fg = colors.cyan6},
  TSKeywordFunction     = { fg = colors.cyan6},
  TSKeywordOperator     = { fg = colors.cyan6},
  TSKeywordReturn       = { fg = colors.purple2 },
  TSLabel               = { fg = colors.blue2 },
  TSLiteral             = { fg = colors.yellow4 },
  TSMethod              = { fg = colors.yellow3 },
  TSNamespace           = { fg = colors.cyan3 },
  TSNumber              = { fg = colors.green3 },
  TSOperator            = { fg = colors.fg },
  TSParameter           = { fg = colors.blue2 },
  ...
  TSQueryLinterError    = { fg = colors.orange1 },
  TSRepeat              = { fg = colors.purple2 },
  TSString              = { fg = colors.orange2 },
  TSStringEscape        = { fg = colors.yellow4 },
  TSStringRegex         = { fg = colors.orange2 },
  TSStrong              = { fg = colors.yellow4 },
  TSStructure           = { fg = colors.blue2 },
  TSSymbol              = { fg = colors.blue2 },
  TSTag                 = { fg = colors.cyan6},
  TSTagDelimiter        = { fg = colors.gray3 },
  TSText                = { fg = colors.fg },
  TSTitle               = { fg = colors.cyan6, style = 'bold' },
  TSType                = { fg = colors.cyan3 },
  TSTypeBuiltin         = { fg = colors.cyan6},
  TSURI                 = { fg = colors.yellow4, style = 'underline' },
  TSUnderline           = { style = 'underline' },
  TSVariable            = { fg = colors.blue2 },
  TSVariableBuiltin     = { fg = colors.blue2 },
  -----------------------------------------
